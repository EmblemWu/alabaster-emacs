...
(let ((bg "#1F1F1F")
  ...
  (custom-theme-set-faces
   ...
   ;; Explicit background prevents "bleed" when another theme set a bg.
   `(font-lock-doc-face ((t (:foreground ,green :background ,bg))))
   `(font-lock-doc-string-face ((t (:foreground ,green :background ,bg))))
   `(font-lock-function-name-face ((t (:foreground ,blue))))
   `(font-lock-keyword-face ((t (:foreground ,purple))))
   `(font-lock-preprocessor-face ((t (:foreground ,punct))))
   `(font-lock-string-face ((t (:foreground ,green :background ,bg))))
